...
// Add Nunjucks function called 'selected' to populate radios and checkboxes
exports.addSelectedFunction = function (env) {
  env.addGlobal('selected', function (name, value) {
    // Check data exists
    if (this.ctx.data === undefined) {
      return ''
    }
